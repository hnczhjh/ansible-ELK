...
These accounts are required for Elasticsearch image installation and configuration

## Elasticsearch

* Elasticsearch administrator username: `admin`
* Elasticsearch administrator password: stored in the file of your server */credentials/password.txt*
