...
The Elasticsearch deployment package contains a sequence software (referred to as "components") required for Elasticsearch to run. The important information such as the component name, installation directory path, configuration file path, port, version, etc. are listed below.
...
| --- | --- | --- | --- |
| HTTP | 8161 | HTTP requests for Elasticsearch Console| Required |
...
rabbitmqctl status | grep Elasticsearch*
```
