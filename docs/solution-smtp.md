...
Sending mail is a common feature for Elasticsearch. After a large number of user practice feedback, only one way is recommended, that is, using the **third-party STMP service** to send the email.
...
1. Log in SendGrid console, prepare your SMTP settings like the follow sample
   ...
   ```
2. Log in Elasticsearch Console
