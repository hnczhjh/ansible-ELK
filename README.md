...
更多请见 [官方 System requirement](https://www.elasticsearch.com/download.html)
...
```
wget -N https://raw.githubusercontent.com/Websoft9/ansible-linux/master/scripts/install.sh; bash install.sh -r elasticsearch
```
...
多种原因导致无法顺利安装，请使用我们在公有云上发布的 [Elasticsearch 镜像](https://apps.websoft9.com/elasticsearch) 的部署方式


## 文档

文档链接：https://support.websoft9.com/docs/elasticsearch/zh
